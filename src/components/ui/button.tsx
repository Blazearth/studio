...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wider [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", // Changed rounded-md to rounded-lg, added uppercase and tracking-wider
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 btn-glow", // Added btn-glow
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 btn-glow", // Added btn-glow
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground btn-glow", // Added btn-glow
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 btn-glow", // Added btn-glow
        ghost: "hover:bg-accent hover:text-accent-foreground", // No glow for ghost
